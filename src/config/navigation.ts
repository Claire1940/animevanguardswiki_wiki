import { Gift, Trophy, Users, Coins, BookOpen, Dna, Package, type LucideIcon } from 'lucide-react'
...
export const NAVIGATION_CONFIG: NavigationItem[] = [
	...
	{ key: 'values', path: '/values', icon: Coins, isContentType: true },
...
) // 移除开头的 '/' -> ['codes', 'tier', 'units', 'values', 'evolution', 'guide', 'items']
